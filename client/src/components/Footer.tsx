const Footer = () => {
  ...
  return (
    <footer className="bg-[#090808] text-white p-6 grid grid-cols-1 md:grid-cols-4 gap-6 absolute top-[5067px] left-1/2 -translate-x-1/2 w-[1340px] h-[215px]" style={{ transformOrigin: "top left" }}>
      ...
      <div className="absolute right-6 top-6">
        <button onClick={scrollToTop} className="bg-white text-black p-2 rounded-full shadow-md hover:bg-gray-200 transition" aria-label="Scroll to top">
